        ...
        <div className="grid gap-8 text-center sm:text-left sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="space-y-2">
            ...
            <ul className="space-y-2 text-sm text-slate-600 dark:text-white/60">
              <li>
                <a className="hover:text-blue-500 dark:hover:text-blue-300 hover:underline" href="#hero">
                  Home
                </a>
              </li>
              <li>
                <a
                  className="hover:text-blue-500 dark:hover:text-blue-300 hover:underline"
                  href="#projects"
                >
                  Projects
                </a>
