      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="space-y-10">
          {projects.map((project) => (
            <motion.div
              key={project.name}
              className="rounded-2xl bg-white/70 dark:bg-white/5 backdrop-blur-xl border border-slate-200 dark:border-white/10 shadow-[0_16px_32px_rgba(15,23,42,0.08)] shadow-[0_0_24px_rgba(147,197,253,0.45)] dark:shadow-[0_0_24px_rgba(59,130,246,0.45)] p-8 grid lg:grid-cols-2 gap-8 items-center transition-transform duration-300 hover:scale-[1.02] hover:-translate-y-1 hover:shadow-[0_0_32px_rgba(147,197,253,0.55)] dark:hover:shadow-[0_0_32px_rgba(59,130,246,0.6)]"
            ...
            >
              <div className="space-y-5">
                ...
                <div className="flex gap-3">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="px-5 py-2.5 text-sm font-semibold rounded-full bg-blue-300 dark:bg-blue-500 text-slate-900 dark:text-white shadow-md transition hover:shadow-[0_0_18px_rgba(59,130,246,0.45)]"
                  >
                    Live Demo
                  </a>
                  <a
                    href={project.repo}
                    className="px-5 py-2.5 text-sm font-semibold rounded-full border border-slate-300 text-slate-700 hover:border-slate-400 dark:border-white/20 dark:text-white/80 dark:hover:border-white/40 transition hover:shadow-[0_0_18px_rgba(59,130,246,0.45)]"
                  >
                    GitHub
                  </a>
                </div>
              ...
              <div className="relative group">
                ...
                <img
                  src={project.image}
                  alt={project.name}
                  className="relative rounded-2xl w-full h-64 object-cover shadow-lg dark:shadow-none"
                />
              </div>
            </motion.div>
          ))}
