      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-20">
          {primaryCategories.map((category) => (
            <div key={category.title} className="relative">
              <div className="skill-box min-h-[280px] space-y-4 p-6 glass rounded-none border-2 border-slate-300/50 dark:border-white/30 shadow-[0_10px_24px_rgba(147,197,253,0.35)] dark:shadow-[0_10px_24px_rgba(29,78,216,0.45)] transition-transform duration-300 hover:scale-[1.03]">
        ...
        >
          <motion.div variants={item} className="space-y-4">
            <div className="glass rounded-2xl p-6 shadow-[0_10px_24px_rgba(147,197,253,0.35)] dark:shadow-[0_10px_24px_rgba(29,78,216,0.45)] transition-transform duration-300 hover:scale-[1.02]">
              <h3 className="text-lg font-semibold text-slate-900 dark:text-white text-center">
                Core Subjects
              </h3>
              <div className="mt-4 grid grid-cols-3 gap-4">
                {coreSubjects.map((skill) => {
