...
export default function Hero({ theme }) {
  ...
  return (
    <section
      id="hero"
      className={`relative min-h-screen flex items-center pt-24 ${isDark ? "bg-black text-white" : "bg-white text-black"}`}
    >
      <div className="relative max-w-6xl mx-auto px-6 w-full">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              <img
                ...
                className={`relative h-[clamp(300px,45vw,520px)] w-auto ${
          ...
          >
            <h1
              className="mt-4 font-bebas text-[clamp(4rem,12vw,9rem)] leading-none tracking-normal text-transparent"
              style={{ WebkitTextStroke: isDark ? "1px #ffffff" : "2px #000000" }}
            >
              JIYA'S
            </h1>
            <h2 className={`font-bebas text-[clamp(4.2rem,13vw,9.5rem)] leading-none font-normal tracking-wide ${isDark ? "text-white/90" : "text-black"}`}>
              PORTFOLIO
            </h2>
            <p className="mt-5 text-lg text-blue-300 dark:text-blue-500">
              {typed}
            ...
            >
              <a
                href="#projects"
                className={`inline-flex items-center justify-center px-6 py-3 rounded-full text-sm font-semibold transition hover:scale-105 shadow-[0_0_18px_rgba(59,130,246,0.35)] ${
                  isDark
                    ? "bg-white text-black "
                    : "bg-black text-white "
                }`}
              ...
              <a
                ...
                className={`inline-flex items-center justify-center px-6 py-3 rounded-full text-sm font-semibold border transition hover:scale-105 shadow-[0_0_18px_rgba(59,130,246,0.35)] ${
                  isDark
            ...
            <div className={`mt-6 flex items-center justify-start gap-4 ${isDark ? "text-white/70" : "text-black/70"}`}>
